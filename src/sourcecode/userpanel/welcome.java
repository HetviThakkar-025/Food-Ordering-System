...
public class welcome extends JFrame {
	...
	public welcome() {
		...
		ImageIcon myimg = new ImageIcon("D:\\images\\home2.jpg");
		...
		ImageIcon m1 = new ImageIcon("D:\\images\\plt2.png");
		...
		ImageIcon myimg2 = new ImageIcon("D:\\images\\logo.png");
		...
		btnUser.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/foodorderingsystem",
							"root", "");
